...
function create()  {
  ...
  const createShortenedLink = async (originalLink, accessPermission, credentials) => {
    // ส่งคำขอไปยังเว็บแอปพลิเคชันของคุณเพื่อสร้างลิงค์คลูกิ้งƒ
    // และรับคำตอบที่มีลิงค์คลูกิ้งที่กำหนดสิทธิ์การเข้าถึงแล้ว
    // เช่นผ่าน API หรือการเขียนเว็บแอปพลิเคชันของคุณเอง

    // ตัวอย่างการส่งคำขอผ่าน Fetch API
  ...
  <div className="top-nav clip-contents">
          ...
          */}<img
          ...
          <div className="frame-63">
            <div className="frame-62">
             ...
             {/*import file*/}
            <input className="custom-file-input" type="file"  accept="application/pdf" onChange={handleFileChange}/> {/*onChange={handleFileChange} */}
             {/*import file*/}
      ...
      <select className="select_sharelink" name="sharelink" id="sharelink">
        ...
        <div className="frame-161">
          <div type="button" onClick={handleCopyLink} className="frame-159">
            ...
            <div className="frame-144">
              ...
              <div className="personal-details-1">
                ...
                <div className="frame-85">
                  ...
                  />
                  <p type="button" className="personal-id" 
                  draggable
                  onDragStart={(event) => handleDragStart(event, { name: 'Personal ID' })}
                  onDragOver={handleDragOver}
                  onDrop={handleDrop} 
                  onClick={() => handleListItemClick('Personal ID')}>Personal ID</p>
                </div>
                ...
                <div className="signature-1">
                  <img
                    ...
                    className="edit-3"
                  />
                  <p type="button" className="signature" 
                  draggable
                  onDragStart={(event) => handleDragStart(event, { name: 'Signature' })}
                  onDragOver={handleDragOver}
                  onDrop={handleDrop} 
                  onClick={() => handleListItemClick('Signature')}>Signature</p>
                </div>
              </div>
            </div>
            <div className="frame-143">
              ...
              <div className="company-details-1">
                <div className="company-3">
                  ...
                  />
                  <p type="button" className="company" 
                  draggable
                  onDragStart={(event) => handleDragStart(event, { name: 'Company' })}
                  onDragOver={handleDragOver}
                  onDrop={handleDrop} 
                  onClick={() => handleListItemClick('Company')}>Company</p>
                </div>
                <div className="department-1">
                  <img
                    ...
                    className="users"
                  />
                  <p type="button" className="department" 
                  draggable
                  onDragStart={(event) => handleDragStart(event, { name: 'Department' })}
                  onDragOver={handleDragOver}
                  onDrop={handleDrop} 
                  onClick={() => handleListItemClick('Department ')}>Department</p>
                </div>
                ...
                <div className="salary-1">
                  ...
                  />
                  <p type="button" className="salary" 
                  draggable
                  onDragStart={(event) => handleDragStart(event, { name: 'Salary' })}
                  onDragOver={handleDragOver}
                  onDrop={handleDrop} 
                  onClick={() => handleListItemClick('Salary ')}>Salary</p>
                </div>
              </div>
            </div>
              ...
              <div className="date-time">
                <div className="date-2">
                  <img
                    ...
                    className="calendar"
                  />
                  <p type="button" className="date" 
                  draggable
                  onDragStart={(event) => handleDragStart(event, { name: 'Date' })}
                  onDragOver={handleDragOver}
                  onDrop={handleDrop} 
                  onClick={() => handleListItemClick('Date ')}>Date</p>
                </div>
    ...
    <div className="bottom-nav clip-contents">
      <div className="group-447">
        <div className="frame-109">
          ...
          <div onClick={() => setIsPreviewOpen(true)} type="button" data-toggle="modal" data-target="#myModal_preview" className="preview-1" >
       ...
       <PDFViewer   width={800} height={800} >
          <Document>
            <Page size="A4" style={styles.page}>
              <View style={styles.section}>
                <Text style={styles.content}  onChange={handleContentChange} >{content.replace(/<[^>]+>/g, '')}</Text>
              </View>
            </Page>
          </Document>
        </PDFViewer>
